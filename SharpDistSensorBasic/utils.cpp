...
//
double CircularBuffer::getElement( uint16_t elementNum )
{
...
//
void CircularBuffer::pushElement( double elementVal )
{
  //inc. the pointer
  cBufferLastPtr++;
...
double CircularBuffer::averageLast( uint16_t numElements )
{
